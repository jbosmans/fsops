...
/**
 * The different result states of a diff between content of two paths
 */
var DiffStates = {
    CODE_ADDED : "added",
 ...
 * @constructor
 */
function FileSystemPath(fsPath, Stats){
    this.path = fsPath;
...
/**
 * Lists all children below passed directory path
 * @param {String} sourceDir
 * @param {String|String[]} ignoredNames
 * @returns {String[]}
 */
            ...
            if(sameTypeFiles){
                if (sourcePathInfo.dir) {
                    ...
                    if(sourceReadable && targetReadable){
                        ...
                        if(!sourceReadable){
                            console.error("Not readable source: " + sourcePathInfo.path);
                            noAccessPaths.push(sourcePathInfo);
                        }
                        if(!targetReadable){
                            console.error("Not readable other: " + targetPathInfo.path);
